...
function ModuleCalidadDashboard({ goTo }) {
  const stats = [
    ...
    { label:'% Brotamiento promedio', value: '87.4%', sub: 'meta: 85%', icon:'sun', accent:'olive' },
    { label:'Lotes en proceso', value: 32, sub: 'en 5 sectores', icon:'lots', accent:'earth' },
  ];
  const recientes = [
        ...
        <div className="card">
          <div className="card-header">
            <div>
              ...
              <p className="card-sub">Selecciona el tipo para iniciar un registro</p>
            </div>
          </div>
          <div className="card-body">
            <div className="grid grid-3">
              {formIds.map(id => {
                ...
                return (
                  <button key={id} onClick={() => goTo(id)} style={{
                  ...
                  }} onMouseOver={e=>{e.currentTarget.style.borderColor='var(--vet-leaf)';e.currentTarget.style.transform='translateY(-1px)';e.currentTarget.style.boxShadow='var(--shadow-2)';}}
                     onMouseOut={e=>{e.currentTarget.style.borderColor='var(--line)';e.currentTarget.style.transform='none';e.currentTarget.style.boxShadow='none';}}>
                    ...
                    {hasDraft && <span className="chip chip-warn" style={{alignSelf:'flex-start', marginTop:'auto'}}><span className="chip-dot"></span>Borrador en curso</span>}
                  </button>
                );
              })}
            </div>
